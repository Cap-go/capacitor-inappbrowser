...
| **`useTopInset`**                      | <code>boolean</code>                                                                                                                                                   | Android only. When enabled, applies the system status bar inset as the WebView top margin. Leave disabled to keep the legacy 0px top margin when hosting your own padding.                                                                                                                                                                                                                                                                                                                                                                    | <code>false</code>                                         | 7.19.0 |
