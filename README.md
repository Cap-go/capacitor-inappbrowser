...
| **`hideNavigationBar`**                | <code>boolean</code>                                                                                                                                                   | If true, hides the Android system navigation bar using sticky immersive mode. The navigation bar reappears temporarily when the user swipes from the bottom edge, then auto-hides again. Useful for apps that use immersive mode in their main activity and want the WebView dialog to match. **Android only** — ignored on iOS.                                                                                                                                                                                                                           | <code>false</code>                                            | 8.2.1  |
