...
| **`invisibilityMode`**                 | <code><a href="#invisibilitymode">InvisibilityMode</a></code>                                                                                                          | Controls how a hidden webview reports its visibility and size. - AWARE: webview is aware it's hidden (dimensions may be zero). - FAKE_VISIBLE: webview is hidden but reports fullscreen dimensions (Android only).                                                                                                                                                                                                                                                                                                                                         | <code>InvisibilityMode.AWARE</code>                           |        |
...
| **`FAKE_VISIBLE`** | <code>'FAKE_VISIBLE'</code> | WebView is hidden but reported as fullscreen (Android only). |
