...
| **`method`**                           | <code>string</code>                                                                                                                                                    | HTTP method to use for the initial request. When specified with 'POST', 'PUT', or other methods that support a body, you can also provide a `body` parameter with the request payload.                                                                                                                                                                                                                                                                                                                                                                     | <code>"GET"</code>                                            | 8.2.0  |
| **`body`**                             | <code>string</code>                                                                                                                                                    | HTTP body to send with the request when using POST, PUT, or other methods that support a body. Should be a string (use JSON.stringify for JSON data). Only used when `method` is specified and supports a request body.                                                                                                                                                                                                                                                                                                                                    |                                                               | 8.2.0  |
