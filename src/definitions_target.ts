...
export interface InAppBrowserPlugin {
  ...
  * @param options {Object} Details of the script to run, specifying either a file or code key.
   ...
   * options.?options {string | InAppBrowserOptions} Options for the InAppBrowser. Optional, defaulting to: location=yes.
   *                 The options string must not contain any blank space, and each feature's
   *                 name/value pairs must be separated by a comma. Feature names are case insensitive.
   */
  open(options: InAppBrowserOpenOptions): Promise<{ value: string }>;
  /**
